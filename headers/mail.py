# Generated on 2019-02-02T21:14:04.392000
...
# experimental, [RFC-ietf-dmarc-arc-protocol-23]
...
# standard, [RFC6857 Section 3.1.10]
...
# standard, [RFC6477][ACP123 Appendix A1.1 and Appendix B.105]
MMHS_EXEMPTED_ADDRESS = "MMHS-Exempted-Address"

# standard, [RFC6477][ACP123 Appendix A1.2 and Appendix B.106]
MMHS_EXTENDED_AUTHORISATION_INFO = "MMHS-Extended-Authorisation-Info"

# standard, [RFC6477][ACP123 Appendix A1.3 and Appendix B.107]
MMHS_SUBJECT_INDICATOR_CODES = "MMHS-Subject-Indicator-Codes"

# standard, [RFC6477][ACP123 Appendix A1.4 and Appendix B.108]
MMHS_HANDLING_INSTRUCTIONS = "MMHS-Handling-Instructions"

# standard, [RFC6477][ACP123 Appendix A1.5 and Appendix B.109]
MMHS_MESSAGE_INSTRUCTIONS = "MMHS-Message-Instructions"

# standard, [RFC6477][ACP123 Appendix A1.6 and Appendix B.110]
MMHS_CODRESS_MESSAGE_INDICATOR = "MMHS-Codress-Message-Indicator"

# standard, [RFC6477][ACP123 Appendix A1.7 and Appendix B.111]
MMHS_ORIGINATOR_REFERENCE = "MMHS-Originator-Reference"

# standard, [RFC6477][ACP123 Appendix A1.8 and Appendix B.101]
MMHS_PRIMARY_PRECEDENCE = "MMHS-Primary-Precedence"

# standard, [RFC6477][ACP123 Appendix A1.9 and Appendix B.102]
MMHS_COPY_PRECEDENCE = "MMHS-Copy-Precedence"

# standard, [RFC6477][ACP123 Appendix A1.10 and Appendix B.103]
MMHS_MESSAGE_TYPE = "MMHS-Message-Type"

# standard, [RFC6477][ACP123 Appendix A1.12 and Appendix B.113]
...
# standard, [RFC6477][ACP123 Appendix A1.14 and Appendix B.116]
MMHS_ACP127_MESSAGE_IDENTIFIER = "MMHS-Acp127-Message-Identifier"

# standard, [RFC6477][ACP123 Appendix A1.15 and Appendix B.117]
...
# standard, [draft-levine-mailbomb-header]
FORM_SUB = "Form-Sub"
...
# standard, [draft-koenig-privicons]
PRIVICON = "Privicon"
